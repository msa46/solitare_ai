...
class Deck:
    ...
    def handle_click(self, mouse_position):
        ...
        valid_move = False
        print("mouse_clicked out",mouse_position)
        if self.selection == False:
            ...
            if self.selected_pile != None and pile_to_transfer_to != None:
                print("selected cards is:",self.selected_cards)
                valid_move = self.selected_pile.transfer_cards(self.selected_cards, pile_to_transfer_to, self.ranks)
                print("selected_cards" ,self.selected_cards )
                print("pile_to_transfer_to", pile_to_transfer_to)
                print("rank",self.ranks)
                print("mouse_clicked",mouse_position)
    ...
    # def move_ai(self , selected_cards,selected_pile, destenation_pile):
    #     piles_to_update = None
    #     valid_move = False
    #     if self.selected_pile.pile_type == 'stock':
    #         valid_move = True
